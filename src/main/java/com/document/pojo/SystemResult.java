...
//    }
     ...
     * @return
     */
    public static SystemResult formatToPojo(String jsonData, java.lang.Class<?> clazz) {
        try {
            if (clazz == null) {
     ...
     * @return
     */
    public static SystemResult formatToList(String jsonData, java.lang.Class<?> clazz) {
        try {
            JsonNode jsonNode = MAPPER.readTree(jsonData);
            JsonNode data = jsonNode.get("data");
            Object obj = null;
